...
public class Darstellung3D
{
    ...
    private GeometryModel3D _oberflächenModell, _drahtModell;
    private GeometryModel3D _randbedingungenModell, _randbedingungenBoussinesqModell;
    private GeometryModel3D _knotenLastenModell, _verformungsModell, _spannungenModell;
    ...
    private readonly Dictionary<Point3D, int> _punktDictionary = [];
    ...
    // Falls ein Punkt schon definiert ist, lies den Index, andernfalls erzeuge den Punkt und lese den neuen Index

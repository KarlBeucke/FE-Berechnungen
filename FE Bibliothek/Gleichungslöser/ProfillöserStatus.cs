...
namespace FEBibliothek.Gleichungslöser
{
    ...
    public class ProfillöserStatus
    {
        ...
        public ProfillöserStatus(double[][] mat, double[] vec,
              double[] prim, bool[] stat, int[] prof)
        {
            _matrix = mat;
            _vector = vec;
            _primal = prim;
        ...
        public void SetzRechteSeite(double[] newVector) { _vector = newVector; }
        ...
        public void Dreieckszerlegung()
        {
            ...
            for (_row = 0; _row < _dimension; _row++)
            {
                ...
                if (sum < double.Epsilon) throw new BerechnungAusnahme("Gleichungslöser: Element <= 0 in Dreieckszerlegung von Zeile " + _row);

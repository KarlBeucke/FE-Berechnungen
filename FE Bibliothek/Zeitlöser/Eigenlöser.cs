...
namespace FEBibliothek.Zeitlöser
{
    ...
    {
        // A*xi = λi*B*xi mit: xi-Eigenvektoren, λi-Eigenwerte
        ...
        private int _anzahlZustände;     // Anzahl Eigenlösungen berechnet
        private readonly bool[] _status; // true: Verformung eingeprägt

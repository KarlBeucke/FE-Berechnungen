...
namespace FEBibliothek.Zeitlöser
{
    public class Zeitintegration2OrdnungStatus
    {
        ...
        public void Ausführen()
        {
            ...
            {
                case 1:
                    alfa = 0; theta = 1; beta = _parameter1; gamma = _parameter2;
                    break;
                case 2:
                    beta = 1.0 / 6; gamma = 0.5; alfa = 0; theta = _parameter1;
                    break;
                case 3:
                    theta = 1; alfa = _parameter1; gamma = 0.5 - alfa; beta = 0.25 * (1 - alfa) * (1 - alfa);
                    break;
                default:
                    throw new BerechnungAusnahme("Zeitintegration2OrdnungStatus: ungültiger Identifikator für Methode eingegeben");
            }

...
public partial class StartFenster
{
    ...
    private FeModell _tragwerksModell;
    ...
    private void WärmedatenEinlesen(object sender, RoutedEventArgs e)
    {
        ...
        if (Directory.Exists(_dateiDialog.InitialDirectory + "\\FE-Berechnungen-App\\input"))
        {
            _dateiDialog.InitialDirectory += "\\FE-Berechnungen-App\\input\\Wärmeberechnung";
    ...
    private void TragwerksdatenEinlesen(object sender, RoutedEventArgs e)
    {
        ...
        if (Directory.Exists(_dateiDialog.InitialDirectory + "\\FE-Berechnungen-App\\input"))
        {
            _dateiDialog.InitialDirectory += "\\FE-Berechnungen-App\\input\\Tragwerksberechnung";
            _dateiDialog.ShowDialog();
        }
        else
        {
        ...
        TragwerkVisual = new Tragwerksberechnung.ModelldatenAnzeigen.TragwerkmodellVisualisieren(_tragwerksModell);
        TragwerkVisual.Show();
    }
    ...
    private void TragwerksdatenSichern(object sender, RoutedEventArgs e)
    {
        ...
        {
            "ModellName",
            _tragwerksModell.ModellId,
            "\nRaumdimension",
            _tragwerksModell.Raumdimension + "\t" + _tragwerksModell.AnzahlKnotenfreiheitsgrade,
            // Knoten
            "\nKnoten"
        };

        switch (_tragwerksModell.Raumdimension)
        {
            case 1:
                zeilen.AddRange(_tragwerksModell.Knoten.Select(knoten => knoten.Key
        ...
        foreach (var item in _tragwerksModell.Elemente)
        {
            switch (item.Value)
            {
        ...
        var alleQuerschnitte = _tragwerksModell.Querschnitt.Select(item => item.Value).ToList();
        ...
        // Materialien
        zeilen.Add("\nMaterial");
        foreach (var item in _tragwerksModell.Material)
        {
            sb.Clear();
            sb.Append(item.Value.MaterialId + "\t" + item.Value.MaterialWerte[0]);
            for (var i = 1; i < item.Value.MaterialWerte.Length; i++)
        ...
        // Lasten
        foreach (var item in _tragwerksModell.Lasten)
        {
            zeilen.Add("\nKnotenlast");
            sb.Clear();
        ...
        foreach (var item in _tragwerksModell.PunktLasten)
        {
        ...
        foreach (var item in _tragwerksModell.ElementLasten)
        {
            sb.Clear();
            zeilen.Add("\nLinienlast");
        ...
        zeilen.Add("\nLager");
        foreach (var item in _tragwerksModell.Randbedingungen)
        {
    ...
    private void TragwerksdatenAnzeigen(object sender, RoutedEventArgs e)
    {
        ...
        {
            var tragwerk = new Tragwerksberechnung.ModelldatenAnzeigen.TragwerkdatenAnzeigen(_tragwerksModell);
            tragwerk.Show();
        }
        else
        {
    ...
    private void TragwerksdatenBerechnen(object sender, RoutedEventArgs e)
    {
        if (_tragwerksModell != null)
        {
            ModellBerechnung = new Berechnung(_tragwerksModell);
            ModellBerechnung.BerechneSystemMatrix();
            ModellBerechnung.BerechneSystemVektor();
            ModellBerechnung.LöseGleichungen();
            Berechnet = true;
    ...
    private void StatikErgebnisseAnzeigen(object sender, RoutedEventArgs e)
    {
        if (_tragwerksModell != null)
        {
            ...
            var ergebnisse = new Tragwerksberechnung.Ergebnisse.StatikErgebnisseAnzeigen(_tragwerksModell);
            ergebnisse.Show();
        }
        else
        {
    ...
    private void StatikErgebnisseVisualisieren(object sender, RoutedEventArgs e)
    {
        if (_tragwerksModell != null)
        {
            ...
            StatikErgebnisse = new Tragwerksberechnung.Ergebnisse.StatikErgebnisseVisualisieren(_tragwerksModell);
    ...
    private void EigenlösungTragwerkBerechnen(object sender, RoutedEventArgs e)
    {
        if (_tragwerksModell != null)
        {
            ...
            // default = 2 Eigenzustände, falls nicht anders spezifiziert
            _tragwerksModell.Eigenzustand ??= new Eigenzustände("default", 2);
            if (_tragwerksModell.Eigenzustand.Eigenwerte != null) return;
            ModellBerechnung.Eigenzustände();
            EigenBerechnet = true;
    ...
    private void EigenlösungTragwerkAnzeigen(object sender, RoutedEventArgs e)
    {
        if (_tragwerksModell != null)
        {
            ...
            // default = 2 Eigenstates, falls nicht anders spezifiziert
            _tragwerksModell.Eigenzustand ??= new Eigenzustände("default", 2);
            if (_tragwerksModell.Eigenzustand.Eigenwerte == null) ModellBerechnung.Eigenzustände();
            var eigen = new Tragwerksberechnung.Ergebnisse.EigenlösungAnzeigen(_tragwerksModell);
            eigen.Show();
        }
        else
        {
    ...
    private void EigenlösungTragwerkVisualisieren(object sender, RoutedEventArgs e)
    {
        if (_tragwerksModell != null)
        {
            ...
            _tragwerksModell.Eigenzustand ??= new Eigenzustände("default", 2);
            if (_tragwerksModell.Eigenzustand.Eigenwerte != null) ModellBerechnung.Eigenzustände();
            var visual = new Tragwerksberechnung.Ergebnisse.EigenlösungVisualisieren(_tragwerksModell);
            visual.Show();
        }
        else
        {
    ...
    {
        if (ZeitintegrationDaten && _tragwerksModell != null)
        {
            var tragwerk = new Tragwerksberechnung.ModelldatenAnzeigen.DynamikDatenAnzeigen(_tragwerksModell);
            tragwerk.Show();
        }
        else
        {
    ...
    private void AnregungVisualisieren(object sender, RoutedEventArgs e)
    {
        ...
        {
            ModellBerechnung ??= new Berechnung(_tragwerksModell);
            var anregung = new Tragwerksberechnung.ModelldatenAnzeigen.AnregungVisualisieren(_tragwerksModell);
            anregung.Show();
        }
        else
        {
    ...
    {
        if (ZeitintegrationBerechnet && _tragwerksModell != null)
        {
            _ = new Tragwerksberechnung.Ergebnisse.DynamischeErgebnisseAnzeigen(_tragwerksModell);
        }
        else
        {
    ...
    private void DynamischeModellzuständeVisualisieren(object sender, RoutedEventArgs e)
    {
        if (ZeitintegrationBerechnet && _tragwerksModell != null)
        {
            var dynamikErgebnisse = new Tragwerksberechnung.Ergebnisse.DynamischeModellzuständeVisualisieren(_tragwerksModell);
    ...
    private void KnotenzeitverläufeTragwerkVisualisieren(object sender, RoutedEventArgs e)
    {
        if (ZeitintegrationBerechnet && _tragwerksModell != null)
        {
            var knotenzeitverläufe = new Tragwerksberechnung.Ergebnisse.KnotenzeitverläufeVisualisieren(_tragwerksModell);
    ...
    private void ElastizitätsdatenEinlesen(object sender, RoutedEventArgs e)
    {
        ...
        if (Directory.Exists(_dateiDialog.InitialDirectory + "\\FE-Berechnungen-App\\input"))
        {
            _dateiDialog.InitialDirectory += "\\FE-Berechnungen-App\\input\\Elastizitätsberechnung";
            _dateiDialog.ShowDialog();
        }
        else
        {

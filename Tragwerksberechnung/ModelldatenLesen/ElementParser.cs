                    ...
                    case 5:
                        {
                            ...
                            var querschnittId = _substrings[3];
                            var materialId = _substrings[4];
                            _element = new Fachwerk(_nodeIds, querschnittId, materialId, _modell)
                            {
                    ...
                    case 5:
                        {
                            ...
                            var querschnittId = _substrings[3];
                            var materialId = _substrings[4];
                            _element = new Biegebalken(_nodeIds, querschnittId, materialId, _modell)
                            {
                                ElementId = _elementId
                            };
                            _modell.Elemente.Add(_elementId, _element);

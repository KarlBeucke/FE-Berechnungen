...
public partial class AnregungVisualisieren
{
    ...
    private void BtnExcitation_Click(object sender, RoutedEventArgs e)
    {
        ...
        StartFenster.ModellBerechnung.AusDatei(inputDirectory, 1, _anregung);
    ...
    {
        var anregungsWerte = duration.ToString("N2") + " [s] resp. "
                                   + (duration / 60 / 60).ToString("N0") + "[h]  Anregung mit "
